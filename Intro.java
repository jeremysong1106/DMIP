...
public class Intro {
     ...
     */
    String outputDataLoc = System.getProperty("user.home") + "/midpa/output";
	...
	public void basicIntro() {
		...
		v1=new SimpleVector(3.0f,2.0f,1.0f);
		//TODO
		if (v1 != null)
		...
		M.setColValue(0, new SimpleVector(1,4,7));//TODO
		M.setColValue(1, new SimpleVector(2,5,8));//TODO
		M.setColValue(2, new SimpleVector(3,6,9));//TODO
		if (M != null)
		...
		subVector= new SimpleVector(2);
		subVector.addToElement(0,M.getElement(0, 2));
		subVector.addToElement(1,M.getElement(1, 2));
		//TODO
		if (subVector != null)
		...
		MsquaredElem=new SimpleMatrix(M);
	...
	public void signalIntro()
	{
		...
		{
			y[i] = Math.sin(2*Math.PI*stepSize*i); //TODO
	...
	public void gridIntro(){
		...
		imageFileName = "mr12out.png"; // TODO: choose a valid filename (just file+ending, no path)
		
		outFileName = outputDataLoc + imageFileName;
		if (mrImage != null) {
			IJ.save(outFileName);//TODO: save the image using IJ and ImageUtil
		}			
	}
